...
export class SpotifyAuthorization {
    ...
    private static readonly clientId = import.meta.env
        .VITE_SPOTIFY_CLIENT_ID as string;
    private static readonly redirectUrl = import.meta.env
        .VITE_SPOTIFY_REDIRECT_URL as string;
    ...
    public static async authorize() {
        ...
        const params = {
            ...
            scope: SpotifyAuthorization.scopes.join(" "),
