...
import { SpotifyPagedResult, SpotifyTimeRanges, SpotifyTrack, SpotifyUser } from "./spotifyDTOs";
...
export class Spotify {
    ...
    public static async getTopTracks(timeRange: SpotifyTimeRanges = "medium_term", limit: number = 20, offset: number = 0): Promise<SpotifyPagedResult<SpotifyTrack>> {        
