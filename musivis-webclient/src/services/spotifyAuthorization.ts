...
export class SpotifyAuthorization {
    ...
    public static async exchangeCodeForToken(code: string) {
        ...
        // set code verifier to empty to ensure it is not used again
        ...
        setTimeout(SpotifyAuthorization.getRefreshToken, response.expires_in * 1000);
    ...
    public static async getRefreshToken() {
        ...
        // Set refresh token to empty to ensure it is not used again
